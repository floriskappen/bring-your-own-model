...
- Security invariants (mandatory): in-memory by default with opt-in persistence, strict CSP, minimal third-party JS, no logging of key or key-linked prompts, pre-flight token estimation with enforceable user-set budget limits.
- Wizard UX contract.
