...
This constitution is consumed as a **git submodule pinned to a release tag** (e.g. `v1.0.0`). Consuming repos pin a version deliberately; see the repo README for the concrete add/bump commands.
